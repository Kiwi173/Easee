...
type Register struct {
	...
	Type    string `validate:"oneof Holding Input" ui:"de=Typ"`
	Decode  string `validate:"oneof uint16 uint32 uint32s uint64 int16 int32 int32s float32 float32s float64" ui:"de=Kodierung"`
}
